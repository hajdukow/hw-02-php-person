...
<head>
    <meta charset="UTF-8">
    <title>Алгоритм поиска идеальной пары</title>
</head>
<body>
...
function getGenderDescription($arrayGender) {
    ...
    echo <<<HEREDOC
    <p><b>Гендерный состав аудитории:</b><br>
    <hr style="border: 1px dashed; width: 215px; float: left;"><br>
    Мужчины - $percentMale%<br>
    Женщины - $percentFemale%<br>
    Не удалось определить - $percentUnknown%</p>
    HEREDOC;
